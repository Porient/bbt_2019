<template>
  <div>
    <a-tabs defaultActiveKey="1" @change="callback">
      <a-tab-pane tab="手机" key="1">
        <div>
          <div class="batchButton">
            <a-button
              type="primary"
              @click="handleReload"
              :loading="produce_loading"
              class="button"
              >批量生成</a-button
            >
            <a-popconfirm
          ...
          <a-table
            ...
            :rowSelection="{
              selectedKeys: selectedRowKeys_phone,
      ...
      <a-tab-pane tab="电脑" key="2" forceRender>
          <div>
          <div class="batchButton">
            <a-button
              type="primary"
          ...
          <a-table
            ...
            :pagination="{ pageSize: 50 }"
            :rowSelection="{
              selectedKeys: selectedRowKeys_computer,
              onChange: onSelectChange,
            }"
          >
            <span slot="action" slot-scope="text, record" style>
