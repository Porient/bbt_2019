  ...
  <div>
    ...
    >
      ...
      <span slot="action" slot-scope="text,record" style>
        ...
        >查看报告</a-button>
        <a-button class="button" href="javascript:;" style="color:rgb(29,165,122);border-color:rgb(29,165,122)" size=small>编辑</a-button>
        <a-button class="button" href="javascript:;" type="danger" size=small ghost>删除</a-button>
      </span>
